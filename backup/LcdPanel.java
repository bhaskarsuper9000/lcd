...
class LcdPanel extends JPanel {
	...
	public LcdPanel()
	{
		...
		ImageIcon t = new ImageIcon("top_new.png");
		ImageIcon l = new ImageIcon("left_new.png");
		ImageIcon r = new ImageIcon("right_new.png");
		ImageIcon b = new ImageIcon("bottom_new.png");
		ImageIcon tl = new ImageIcon("tl_new.png");
		ImageIcon tr = new ImageIcon("tr_new.png");
		ImageIcon bl = new ImageIcon("bl_new.png");
		ImageIcon br = new ImageIcon("br_new.png");
